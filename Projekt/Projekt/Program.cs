    ...
    public class Program
    {
        ...
        static void Start()
        {
            //Wstęp oraz imie naszej postaci
                        ...
                        Console.WriteLine("A więc twoje imie to " + postac.name + ", grubo");
                        Console.ReadKey();
                        Console.Clear();
                        ...
                        Console.WriteLine(">" + postac.name + " cholerny kryjanie i mnie obudziłeś tym krzykiem, a taki mecz oglądałem");
                        Console.ReadKey();
                        ...
                        Console.WriteLine(">Cholerni żydzi. Niestety mój kochany " + postac.name + ", nie masz wpływu na to, czy izrael kiedyś odpowie za swoje zbrodnie.");
                        Console.ReadKey();
